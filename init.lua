...
-- Move line up, down
vim.keymap.set("v", "J", ":m '>+1<CR>gv=gv", { desc = "Move one line up" })
vim.keymap.set("v", "K", ":m '<-2<CR>gv=gv", { desc = "Move one line down" })
...
require("lazy").setup({
	...
	-- Useful plugin to show you pending keybinds
	{
		...
		event = "VimEnter", -- :help autocmd-events
		config = function()
	...
	-- Fuzzy Finder (files, lsp, etc)
	{
      ...
      -- stylua: ignore
			vim.keymap.set("n", "<leader>ff",	builtin.current_buffer_fuzzy_find, { desc = "Current buffer [F]uzzy [F]ind" })
	...
	-- LSP Configuration & Plugins
	{
		...
		config = function()
          ...
          -- stylua: ignore
			...
			-- NOTE: Additional tools to install: formatters, linters, etc.
